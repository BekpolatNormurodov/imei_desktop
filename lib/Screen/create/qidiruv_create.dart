...
class QidiruvCreate extends StatefulWidget {
  const QidiruvCreate({Key? key}) : super(key: key);

  @override
  State<QidiruvCreate> createState() => _QidiruvCreateState();
}

class _QidiruvCreateState extends State<QidiruvCreate> {
